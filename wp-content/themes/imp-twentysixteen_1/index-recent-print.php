<?php
$catName = "recent-print-work";
$argsd = array(
	'post_type' 		=> 'post',
	'posts_per_page' 	=> -1,
	'name' 	=> 'recent-print-work',
);
$my_posts = get_posts($argsd);
foreach($my_posts as $p) { 
	if ($p->post_name == $catName ) { ?>
	<section id="RecentPrint" class="parallax-container white opacity" data-natural-height="1406" data-natural-width="2500" data-image-src="<?php echo $feat_image = wp_get_attachment_url( get_post_thumbnail_id($p->ID) ); ?>" data-speed="0.2" data-bleed="10" data-parallax="scroll" style="height: 611px;">
...
<ul class="see-more-link">
		<li><a class="btn btn-primary" role="button" title="Web Portfolio" id="scEvent" href="/category/print/">See More <i class="fa fa-angle-double-right"></i>
		</a></li>
</ul>
	</div>
</section>