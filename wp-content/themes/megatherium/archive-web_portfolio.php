...
<section class="my-container archive">
    ...
    <div class=" my-inner-container">
        ...
        <div class="mp-row row">
            ...
            <div class="col-lg-4 align-center">
                <img src="/wp-content/themes/imp-twentyseventeen/assets/img/mobile-devices-600x400.png" alt="Responsive Mobile Devices" class="catimg img-responsive">
            </div>
        </div>
    </div>
</section>
